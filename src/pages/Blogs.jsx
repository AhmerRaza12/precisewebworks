...
<section className="bg-white dark:bg-gray-900 mb-10">
  ...
  <div className="text-center py-10">
    <h1 className="text-5xl font-bold text-black dark:text-white ">Blogs</h1>
  ...
  <div className="px-8 py-4 mx-auto lg:max-w-screen-xl sm:max-w-xl md:max-w-full sm:px-12 md:px-16 lg:py-6 sm:py-8">
    <div className="grid gap-x-8 gap-y-12 sm:gap-y-16 md:grid-cols-2 lg:grid-cols-3">
      <div className="relative">
        <Link to={'/blogs/first-blog'} className="block overflow-hidden group rounded-xl shadow-lg">
        ...
        <div className="relative mt-5">
          ...
          <Link to={'/blogs/first-blog'} className="block mb-3 ">
          ...
          <Link to={'/blogs/first-blog'} className="font-medium underline text-maroon hover:text-xs duration-300 dark:text-purple-400">Read More</Link>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="relative mt-5">
          <p className="uppercase font-semibold text-xs mb-2.5 text-maroon">September 15th 2024</p>
      ...
      <div className="relative">
        ...
        <div className="relative mt-5">
          <p className="uppercase font-semibold text-xs mb-2.5 text-maroon">October 5th 2024</p>
          <a href="/" className="block mb-3 ">
            <h2 className="text-2xl font-bold leading-5 text-black dark:text-white transition-colors duration-200 hover:text-red-800 dark:hover:text-purple-400">
