        ...
        <div className="space-y-4  lg:grid md:grid-cols-3 lg:space-y-0 lg:gap-6">
            ...
            <div
                ...
                <div className="my-2 flex items-baseline justify-center ">
                    <span className="mr-1 text-4xl font-extrabold text-maroon">$599</span>
                    <span className="text-red-700 line-through">$1999 only</span>
                </div>
                ...
                <ul  className="mb-4 space-y-1 text-left text-gray-600  text-sm">
                    ...
                    Image Alt Tag Optimization</span>
                    </li>
                    <li className="flex items-center space-x-2">
                    ...
                    <li className="flex items-center space-x-2">
                        ...
                        Internal Links Optimization</span>
                    </li>
                    <li className="flex items-center space-x-2">
...
Local Business Listings</span>
            ...
            <div
                ...
                <div className="my-2 flex items-baseline justify-center ">
                    ...
                    <span className="text-red-700 line-through">$2499 only</span>
                </div>
...
Local Business Listings</span>
            ...
            <div
                className="mx-auto flex max-w-lg space-y-4 items-start flex-col rounded-3xl  bg-[#d9d9d9] p-6 text-maroon xl:p-6 w-full">

                <h3 className="text-lg font-normal uppercase">SEO Platinum</h3>
                <div className="my-2 flex items-baseline justify-center ">
                    <span className="mr-1 text-4xl font-extrabold text-maroon">$1599</span>
