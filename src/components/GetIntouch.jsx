...
const GetIntouch = () => {
  return (
    ...
    <div className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl xl:max-w-6xl py-6">

    
    <div className="w-full h-64 lg:w-1/2 lg:h-auto">
        <img className="h-[500px] w-full object-cover" src={bgImage} alt="Background Getintouch"/>
    </div>
    

   
    <div
        className="max-w-lg bg-primary md:max-w-2xl rounded-md md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
        
        <div className="flex flex-col p-12 md:px-16">
            <h2 className="text-2xl font-medium uppercase  text-gray-300 lg:text-4xl">Get In Touch </h2>
