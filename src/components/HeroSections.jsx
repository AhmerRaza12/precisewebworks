...
const HeroSections = () => {
  return (
    <section className="sm:mt-6 mt-4 mb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

      <div
        className="my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex gap-3 lg:flex lg:items-center flex-col lg:flex-row">
        <div className="sm:text-center lg:text-left lg:w-1/2">
          <h1 className="text-4xl tracking-tight font-extrabold text-primary sm:text-5xl md:text-6xl">
            <span className="block xl:inline">Appealing And Creative</span>
            <span className="block text-maroon xl:inline">Design Services</span>
          </h1>
          <p
        ...
        <div className="lg:inset-y-0 lg:right-0 lg:w-1/2 my-4 lg:flex lg:justify-center lg:items-center">
          <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full" src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80" alt="" />
        </div>
      </div>

      <div className="my-10 mx-auto max-w-7xl px-4 flex gap-3 lg:flex lg:items-center flex-col lg:flex-row-reverse">
        <div className="sm:text-center lg:text-right lg:w-1/2">
          <h1 className="text-4xl tracking-tight font-extrabold text-primary sm:text-5xl md:text-6xl">
            <span className="block xl:inline">Revolutionary Techniques</span>
            <span className="block text-maroon xl:inline">Tailored Designs</span>
          </h1>
          <div className="mt-3 sm:mt-5 ">
            ...
            <p className="mt-3 text-base text-gray-500 sm:text-lg md:text-xl lg:mx-0">
        ...
        <div className="lg:inset-y-0 lg:left-0 lg:w-1/2 my-4 lg:flex lg:justify-center lg:items-center">
          <img
